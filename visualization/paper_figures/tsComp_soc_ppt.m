...
yl = ylabel({'MDP','Battery Profile','[kWh]'},'Color',cmdp(3,:), ...
    'Rotation',0,'Units','normalized','VerticalAlignment','middle');
ylpos = get(yl,'Position');
set(yl,'Position',[ylhpos ylpos(2) ylpos(3)])
set(gca,'XTickLabel',[]);
...
yl = ylabel({'Posterior','Bound','Battery Profile','[kWh]'},'Color',cpbo(3,:), ...
    'Rotation',0,'Units','normalized','VerticalAlignment','middle');
ylpos = get(yl,'Position');
set(yl,'Position',[ylhpos ylpos(2) ylpos(3)])
set(gca,'XTickLabel',[]);
...
yl = ylabel({'Greedy','Logic','Battery Profile','[kWh]'}, ...
    'Color',cgre(3,:)*.85, ...
    'Rotation',0,'Units','normalized','VerticalAlignment','middle');
ylpos = get(yl,'Position');
set(yl,'Position',[ylhpos ylpos(2) ylpos(3)])
...
yl = ylabel({'Duration','Based','Battery Profile','[kWh]'}, ...
    'Color',cdbl(3,:)*.85, ...
    'Rotation',0,'Units','normalized','VerticalAlignment','middle');
ylpos = get(yl,'Position');
set(yl,'Position',[ylhpos ylpos(2) ylpos(3)])
...
if printfig
    print(tscomp,['~/Dropbox (MREL)/Research/Defense/' ...
        'presentation_figures/tscomp_soc'],'-dpng','-r600')
end
