...
sim.sl = false; %toggle for simple logic - SoC based
sim.slv2 = false; %toggle for simple logic v2 - duration based
sim.slv3 = false; %toggle for simple logic v3 - greedy
sim.slv4 = false; %toggle for simple logic v4 - duration/theta based
...
if isequal(batchtype,'tds')
    ...
    elseif isequal(batchsim,'sl3')
        ...
        sim.slv3 = true;
        sim.slv4 = false;
    elseif isequal(batchsim,'sl4')
        sim.pb = false;
        sim.sl = false;
        sim.slv2 = false;
        sim.slv3 = false;
        sim.slv4 = true;
    elseif isequal(batchsim,'mod')
        sim.pb = false;
        sim.sl = false;
        sim.slv2 = false;
        sim.slv3 = false;
